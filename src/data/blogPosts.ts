 ...
 export const blogPosts = [
  ...
  { id: 1,
    ...
    excerpt: 'Yet again, India\'s Current Account Deficit is a mere 10 bp in the quarter (Dec 2023), less than levels more than a decade back, and less than 2017-18 too. Why not of gold? It\'s not really a current account import....',
  ...
  { id: 1,
    ...
    excerpt: 'In the last few days, we have seen increased volatility in the mid and small-cap universe and some stocks now appear richly valued... Followers are advised to...',
